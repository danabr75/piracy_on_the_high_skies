...
class DumbMissileLauncher < Launcher
  ...
  def init_projectile initial_angle, current_map_pixel_x, current_map_pixel_y, destination_angle, start_point, end_point, current_map_tile_x, current_map_tile_y, owner_id, options = {}
