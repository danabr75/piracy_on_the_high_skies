...
module Buildings
  class CommandCenter < Buildings::Building
    ...
    def initialize(current_map_tile_x, current_map_tile_y, window, options = {})
      ...
      @take_over_angle_increment = 360 / (@time_to_be_taken_over / 10.0).to_f
    ...
    def draw viewable_pixel_offset_x, viewable_pixel_offset_y
      if @being_taken_over && @take_over_block == false
        ...
        # current_angle  = 11.0
        current_angle  = -165.0
        while take_over_counter > 0 && take_over_counter <= @time_to_be_taken_over
          ...
          take_over_counter += @take_over_angle_increment
          current_angle     += @take_over_angle_increment
        end
      end
    ...
    def update mouse_x, mouse_y, player_map_pixel_x, player_map_pixel_y, player_x, player_y, player, ships, buildings, options = {}
      ...
      if @being_taken_over
        @take_over_colors = @faction.color
      end
