...
class HorizontalSwarm
  ...
  #   return {
  #     projectiles: [
  #       SemiGuidedMissile.new(@scale, @screen_pixel_width, @screen_pixel_height, self, player, LAUNCHER_MIN_ANGLE, LAUNCHER_MAX_ANGLE, MISSILE_LAUNCHER_INIT_ANGLE, {custom_initial_delay: 2}),
  #       SemiGuidedMissile.new(@scale, @screen_pixel_width, @screen_pixel_height, self, player, LAUNCHER_MIN_ANGLE, LAUNCHER_MAX_ANGLE, MISSILE_LAUNCHER_INIT_ANGLE, {custom_initial_delay: 12, x_homing_padding: x_padding_1}),
  #       SemiGuidedMissile.new(@scale, @screen_pixel_width, @screen_pixel_height, self, player, LAUNCHER_MIN_ANGLE, LAUNCHER_MAX_ANGLE, MISSILE_LAUNCHER_INIT_ANGLE, {custom_initial_delay: 18, x_homing_padding: x_padding_2})
  #     ],
