...
class Mite < GeneralObject
  ...
  # def initialize(scale, x, y, screen_pixel_width, screen_pixel_height, x_direction, options = {})
  #   # initialize(scale, x, y, screen_pixel_width, screen_pixel_height, options = {})
  #   super(scale, x, y, screen_pixel_width, screen_pixel_height, options)
  #   @cooldown_wait = 0
  #   @attack_speed = 1
  #   @health = 2
  #   @armor = 0
  ...
  #   return {
  #     projectiles: [
  #       SemiGuidedMissile.new(@scale, @screen_pixel_width, @screen_pixel_height, self, player, nil, nil, nil, {damage_increase: @damage_factor})
  #     ],
  ...
  # def drops
  #   value = [SmallExplosion.new(@scale, @screen_pixel_width, @screen_pixel_height, @x, @y, nil, {ttl: 2, third_scale: true})]
  #   value << Star.new(@scale, @screen_pixel_width, @screen_pixel_height, @x, @y) if rand(2) == 0
  #   return value
  # end
  ...
  #       end
  #     else
  #       if @x_direction < 0 && @x < 0 - @screen_pixel_width / 2
  #         # puts "CASE 2: "
  #         @switched_directions = true
  #         @x_direction = @x_direction * -1
  #       elsif @x_direction > 0 && @x > @screen_pixel_width + @screen_pixel_width / 2
  #         # puts "CASE 3"
  #         @switched_directions = true
  #         @x_direction = @x_direction * -1
  #       end
