    ...
    def update mouse_x, mouse_y, player_map_pixel_x, player_map_pixel_y
      ...
      if @attached_target
        ...
        if @attached_target.class::IS_MOVABLE_OBJECT
          @attached_target.movement(self.class.pull_strength * 0.5, angle_to_origin) if @attached_target.is_alive
          @owner.movement(self.class.pull_strength * 0.5, angle_to_origin + 180)     if @owner.is_alive
        else
