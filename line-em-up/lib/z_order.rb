module ZOrder
  ...
  Background, Building, GroundProjectile, AIShip, AIShipArmor, AIFactionEmblem, AIHardpointBase, AIHardpoint, AIProjectile, Player, PlayerShipArmor, FactionEmblem, HardpointBase, Hardpoint, PlayerProjectile, Explosions, MenuBackground, HardPointClickableLocation, Launcher, MiniMap, MiniMapIcon, PlayerMiniMapIcon, SpecialMiniMapIcon, UI, CurserUIBuffer, Cursor = *0..50
end
