module ZOrder
  ...
  Background, Building, AIShip, AIHardpointBase, AIHardpoint, AIProjectile, Player, HardpointBase, Hardpoint, PlayerProjectile, Explosions, MenuBackground, HardPointClickableLocation, Launcher, MiniMap, MiniMapIcon, PlayerMiniMapIcon, SpecialMiniMapIcon, UI, CurserUIBuffer, Cursor = *0..50
end
